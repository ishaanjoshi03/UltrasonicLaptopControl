...
while 1: #Do this forever
    inputData = input() #get input from user
    print ("You entered", inputData) #print the intput for confirmation
    
    if (inputData == '1'): #if the value is 1
        ArduinoSerial.write(b'1') #send 1
        print ("LED turned ON")
        time.sleep(1)
    
    if (inputData == '0'): #if the value is 0
